...
SCHEMA = {
    ...
    'AOM': {"essentials": [("aom_freq_mhz", None), ("aom_sound_mps", None), ("aom_efficiency", None)],
            "more": _APERTURE},
    'OPA': {"essentials": [("opa_output", None), ("opa_signal_nm", None), ("opa_output_select", None),
                           ("opa_efficiency", None), ("opa_path_mode", None), ("opa_path_mm", None)],
            "more": [("clear_aperture", None)]},
    'OPA_OUTPUT': {"essentials": [], "more": []},
