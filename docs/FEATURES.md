# Features, examples and release history

The long-form companion to the [README](../README.md): what the add-on can do, the bundled example
scenes, the gallery, what each release added, and how it compares with other tools. Nothing here is
newer than the README; this is the detail the README links to.
