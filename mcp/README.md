...
| `path_statistics` | Report every detector arrival's route, geometric length, phase OPL, and group delay / GDD where the route is modelled |
...
| `detector_spectrum` | Exact arrival wavelengths and resolution-broadened optical power spectrum; optional CSV (relative units) |
